...
terminal = "sakura"
uieditor = "netbeans" or "emacs" or "geany"
...
mysciencemenu = {
   { "Octave", function() awful.spawn(science) end },
...
local function set_wallpaper(s)
    ...
    if beautiful.wallpaper then
        ...
        gears.wallpaper.centered(os.getenv("HOME") .. "/Desktop/Ferrocene.png", s, "#FFFFFFFF", 1.3)
    end
end
...
globalkeys = gears.table.join(
	...
	awful.key({ "Shift",           }, "Alt_L",      kbdcfg1.switch_next,
              {description="Переключи язык", group="lang"}),
